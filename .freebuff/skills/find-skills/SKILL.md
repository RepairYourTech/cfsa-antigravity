...
Workflows that load stack-specific skills may invoke this skill as a fallback when a required skill is not installed in `.freebuff/skills/` and has no matching entry in `.freebuff/skill-library/MANIFEST.md`. In this case:
