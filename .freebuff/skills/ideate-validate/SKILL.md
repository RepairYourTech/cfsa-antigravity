...
1. Run constraint exploration via `.freebuff/skills/prd-templates/references/constraint-exploration.md`.
...
1. Run domain exhaustion criteria from `.freebuff/skills/prd-templates/references/domain-exhaustion-criteria.md`.
...
1. Apply ideation rubric (`.freebuff/skills/pipeline-rubrics/references/ideation-rubric.md`) across all dimensions.
