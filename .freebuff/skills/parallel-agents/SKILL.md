...
2. **QA-RED** — QA agent writes comprehensive failing tests for ALL acceptance criteria. Tests MUST fail. Read `.freebuff/skills/session-continuity/protocols/09-parallel-claim.md`. Every contract field and error type covered.
