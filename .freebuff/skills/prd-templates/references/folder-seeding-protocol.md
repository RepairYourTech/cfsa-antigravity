...
- `.freebuff/skills/prd-templates/references/ideation-index-template.md` (super-index)
- `.freebuff/skills/prd-templates/references/ideation-crosscut-template.md` (global CX)
- `.freebuff/skills/prd-templates/references/fractal-node-index-template.md` (node index)
- `.freebuff/skills/prd-templates/references/fractal-cx-template.md` (node CX)
- `.freebuff/skills/prd-templates/references/fractal-feature-template.md` (feature file)
