...
|--------------|-----------------|-------------------|
| **structure** | `.freebuff/instructions/structure.md` | All IA shards, BE specs, FE specs |
| **tech-stack** | `.freebuff/instructions/tech-stack.md` + architecture doc | All IA shards, BE specs, FE specs |
...
| **patterns** | `.freebuff/instructions/patterns.md` | All IA shards, BE specs with implementation patterns, FE specs with component patterns |
