...
2. **Classification Gate**: Apply Node Classification Gate from `.freebuff/skills/idea-extraction/SKILL.md` — leaf feature or sub-domain folder.
3. **Write**: Use `.freebuff/skills/prd-templates/references/fractal-feature-template.md`. Include:
