...
Read the surface stack map from `.freebuff/instructions/tech-stack.md`.
...
3. **Execute `/bootstrap-agents`** with those keys — read `.freebuff/skills/bootstrap-agents/SKILL.md` and run BOTH shards (fill + provision)
