---
name: setup-verify
description: Verify Freebuff CFSA installation integrity, placeholder completion, and skill readiness
parameters:
  - name: strict
    type: boolean
    required: false
...
Runs post-bootstrap verification for the Freebuff port.
...
Must exist:
- `.freebuff/instructions/`
- `.freebuff/rules/`
- `.freebuff/skills/`
- `.freebuff/instructions/tech-stack.md`
- `.freebuff/skills/utilities/resolve-skill.md`

### Gate 2 — Surface Stack Map validity

In `.freebuff/instructions/tech-stack.md`:
...
- Installed skill folder exists under `.freebuff/skills/` OR
...
### Failed
- Gate 3: unresolved placeholders in `.freebuff/instructions/commands.md`
