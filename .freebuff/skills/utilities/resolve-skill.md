...
1. `.freebuff/instructions/tech-stack.md` must exist and be populated
...
1. Open `.freebuff/instructions/tech-stack.md`
...
**Check**: Does `.freebuff/skills/{skill-name}/SKILL.md` exist?
...
**Check**: Does any skill in `.freebuff/skills/` partially match the name?
...
1. `.freebuff/skill-library/` — Check if skill template exists in library
...
- **Option 3**: Generate stub skill at `.freebuff/skills/{skill}/SKILL.md`, load it
...
{
  "resolved": [
    ".freebuff/skills/supabase/SKILL.md",
    ".freebuff/skills/surrealdb/SKILL.md"
  ],
  "missing": ["pglite"],
  "warnings": [
...
- `.freebuff/instructions/tech-stack.md` — Surface Stack Map source
- `.freebuff/skills/setup/setup-provision-skills.md` — Skill installation
- `.freebuff/skills/setup/setup-cfsa.md` — Initial setup workflow
