...
1. Read and apply input classification protocol from `.freebuff/skills/prd-templates/references/input-classification.md`.
2. Read `.freebuff/skills/idea-extraction/SKILL.md` and run mode-specific path:
...
1. Follow folder seeding protocol from `.freebuff/skills/prd-templates/references/folder-seeding-protocol.md`.
