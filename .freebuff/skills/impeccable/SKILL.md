...
|---|---|---|
| Context | The PRODUCT.md / DESIGN.md loader result is known from `node .freebuff/skills/impeccable/scripts/load-context.mjs`. | Run the loader before continuing. |
...
```bash
node .freebuff/skills/impeccable/scripts/pin.mjs <pin|unpin> <command>
```
