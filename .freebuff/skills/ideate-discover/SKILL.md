...
2. Apply gate behavior from `.freebuff/skills/prd-templates/references/engagement-tier-protocol.md`.
3. If tier missing, default to Hybrid and request override/confirmation.

### Step 3 — Recursive domain exploration

1. Execute recursive exhaustion protocol in `.freebuff/skills/idea-extraction/SKILL.md`.
