...
2. **Indexes at every level.** Template: `.freebuff/skills/prd-templates/references/fractal-node-index-template.md`
3. **CX files at every level.** Template: `.freebuff/skills/prd-templates/references/fractal-cx-template.md`
4. **Feature files are leaf nodes.** Template: `.freebuff/skills/prd-templates/references/fractal-feature-template.md`
...
The top-level `ideation-index.md` uses a different template: `.freebuff/skills/prd-templates/references/ideation-index-template.md`
The top-level `ideation-cx.md` uses: `.freebuff/skills/prd-templates/references/ideation-crosscut-template.md`
