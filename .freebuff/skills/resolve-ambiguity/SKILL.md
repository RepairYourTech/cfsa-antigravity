...
- `.freebuff/instructions/tech-stack.md` — Technology decisions
- `.freebuff/instructions/patterns.md` — Code conventions
- `.freebuff/instructions/structure.md` — Directory layout
- `.freebuff/instructions/commands.md` — Dev, test, lint, build
