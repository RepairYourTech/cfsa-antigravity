...
After reading the methodology below, read the reference matching your surface's Languages column in the surface stack map (`.freebuff/instructions/tech-stack.md`):
