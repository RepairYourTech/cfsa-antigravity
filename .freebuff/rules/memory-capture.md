...
## Native Memory Sync (Freebuff)

When running in Freebuff, memory capture is dual-write:
...
2. Evaluate native-memory relevance and sync to Freebuff native memory store:
