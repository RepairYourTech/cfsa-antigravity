...
```bash
python .freebuff/skills/frontend-verification/scripts/ux_audit.py src/components/NewFeature/ --json
```
...
```bash
python .freebuff/skills/frontend-verification/scripts/ux_audit.py src/components/Chart/ \
...
```bash
python .freebuff/skills/frontend-verification/scripts/ux_audit.py src/ --json
```
