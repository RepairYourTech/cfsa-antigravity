...
3. Bootstrap reads `.freebuff/skill-library/MANIFEST.md` and finds matching skills
...
Copy a skill directory from `.freebuff/skill-library/[path]/` to `.freebuff/skills/[name]/`
