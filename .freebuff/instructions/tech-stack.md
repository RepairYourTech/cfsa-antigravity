...
### How Freebuff Workflows Use This Map
...
4. Resolve each skill through the 4-tier resolution chain (see `.freebuff/skills/utilities/resolve-skill.md`)
...
Each cell is a comma-separated list of skill directory names from `.freebuff/skills/`. Use `—` for "not applicable."
...
Verification gates in `workflow-plan-phase` and `workflow-implement-slice` check these conditions. See `.freebuff/skills/setup/setup-verify.md` for the full verification procedure.
