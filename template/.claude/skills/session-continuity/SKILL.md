...
in a single, workflow-driven system. Progress tracking remains in `.claude/progress/`, but shared cross-runtime memory now lives in the project-level `.memory/` root.
