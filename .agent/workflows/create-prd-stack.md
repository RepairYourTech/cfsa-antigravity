...
This axis applies to all visual surfaces (web, desktop, mobile). For projects with no visual surface (CLI-only), use the CLI variant at the end of this section.

**Constraint questions** — ask these five questions first:
...
**Option table** — present 5 options + Hybrid:
...
**Per-axis flow** (same as all other axes):
