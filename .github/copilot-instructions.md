...
## Project: CFSA Antigravity Pipeline

This is a Constraint-First Specification Architecture pipeline. See `AGENTS.md` for the full pipeline workflow. Key commands: `/ideate`, `/create-prd`, `/implement-slice`.
