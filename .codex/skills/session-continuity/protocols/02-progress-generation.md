...
2. **Create or update `.codex/progress/index.md`**:
   ```markdown
...
3. **Create `.codex/progress/phases/phase-NN.md`**:
   ```markdown
   # Phase {{N}}: {{NAME}}
...
4. **Create `.codex/progress/slices/phase-NN-slice-NN.md`** for each slice with ≥3 criteria:
   ```markdown
