...
1. `.factory/instructions/tech-stack.md` must exist and be populated
...
1. Open `.factory/instructions/tech-stack.md`
...
**Check**: Does `.factory/skills/{skill-name}/SKILL.md` exist?
...
**Check**: Does any skill in `.factory/skills/` partially match the name?
...
1. `.factory/skill-library/` — Check if skill template exists in library
...
- **Option 3**: Generate stub skill at `.factory/skills/{skill}/SKILL.md`, load it
...
{
  "resolved": [
    ".factory/skills/supabase/SKILL.md",
    ".factory/skills/surrealdb/SKILL.md"
  ],
  "missing": ["pglite"],
  "warnings": [
...
- `.factory/instructions/tech-stack.md` — Surface Stack Map source
- `.factory/skills/setup-provision-skills/SKILL.md` — Skill installation
- `.factory/skills/setup-cfsa/SKILL.md` — Initial setup workflow
