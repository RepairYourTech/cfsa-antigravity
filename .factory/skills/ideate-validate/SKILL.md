...
1. Run domain exhaustion criteria from `.factory/skills/prd-templates/references/domain-exhaustion-criteria.md`.
...
1. Apply ideation rubric (`.factory/skills/pipeline-rubrics/references/ideation-rubric.md`) across all dimensions.
