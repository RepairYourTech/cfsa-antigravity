...
Workflows that load stack-specific skills may invoke this skill as a fallback when a required skill is not installed in `.factory/skills/` and has no matching entry in `.factory/skill-library/MANIFEST.md`. In this case:
