...
The pipeline has three memory files (`.memory/wiki/patterns.md`, `.memory/wiki/decisions.md`, `.memory/wiki/blockers.md`) — all empty. `workflow.md` Step 5 says "Learn (MANDATORY)" but no enforcement exists. This rule IS the enforcement.
...
1. Write the CFSA entry to `.memory/wiki/{patterns|decisions|blockers}.md`
