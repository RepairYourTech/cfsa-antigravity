...
- `.factory/skills/prd-templates/references/ideation-index-template.md` (super-index)
- `.factory/skills/prd-templates/references/ideation-crosscut-template.md` (global CX)
- `.factory/skills/prd-templates/references/fractal-node-index-template.md` (node index)
- `.factory/skills/prd-templates/references/fractal-cx-template.md` (node CX)
- `.factory/skills/prd-templates/references/fractal-feature-template.md` (feature file)
