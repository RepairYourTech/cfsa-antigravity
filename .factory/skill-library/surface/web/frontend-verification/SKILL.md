...
```bash
python .factory/skills/frontend-verification/scripts/ux_audit.py src/components/NewFeature/ --json
```
...
```bash
python .factory/skills/frontend-verification/scripts/ux_audit.py src/components/Chart/ \
...
```bash
python .factory/skills/frontend-verification/scripts/ux_audit.py src/ --json
```
