...
3. Bootstrap reads `.factory/skill-library/MANIFEST.md` and finds matching skills
...
Copy a skill directory from `.factory/skill-library/[path]/` to `.factory/skills/[name]/`
