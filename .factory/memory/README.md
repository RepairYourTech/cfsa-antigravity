...
1. Write CFSA operational memory to `.factory/memory/*`
...
- `.factory/memory/*` remains the pipeline execution log
...
- `.factory/skills/memory-protocol/SKILL.md` — Memory management skill
- `.factory/skills/progress-tracking/SKILL.md` — Task integration
- `.factory/progress/` — Antigravity's equivalent markdown-based tracking
